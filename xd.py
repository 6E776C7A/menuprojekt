...
# Ścieżki plików
input_gpx_path = "data/pomiar_bez_zaklucen.gpx"  # Ścieżka do pliku wejściowego
output_gpx_path = "data/pomiar_bez_zaklucen_updated.gpx"  # Ścieżka do pliku wyjściowego

# Punkty skrajne (start i koniec) z wysokościami
start_coords = (49 + 25/60 + 37/3600, 19 + 50/60 + 30/3600)  # (49°25'37"N, 19°50'30"E)
end_coords = (49 + 26/60 + 28/3600, 19 + 51/60 + 7/3600)     # (49°26'26"N, 19°51'07"E)
start_ele = 691  # Wysokość w metrach
end_ele = 675    # Wysokość w metrach
